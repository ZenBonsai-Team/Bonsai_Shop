...
class ArtisanProductControllerIntegrationTest {
    ...
    void create_WhenFormIsInvalid_ShouldReturnFormViewWithBindingErrorsAndLookupData() throws Exception {
        ...
        verify(artisanProductService, never()).createProduct(any(String.class), any(ArtisanProductFormDTO.class));
    }
    ...
    void update_WhenFormIsValid_ShouldUpdateProductAndRedirectToPreview() throws Exception {
        ...
        verify(artisanProductService).updateProduct(any(String.class), any(Integer.class), any(ArtisanProductFormDTO.class));
    }
    ...
    void update_WhenFormIsInvalid_ShouldReturnFormViewWithBindingErrorsAndLookupData() throws Exception {
        ...
        verify(artisanProductService, never()).updateProduct(any(String.class), any(Integer.class), any(ArtisanProductFormDTO.class));
    }
    ...
    void update_WhenServiceRejectsValidForm_ShouldReturnFormViewWithError() throws Exception {
        ...
        doThrow(new RuntimeException("Update violates business rule"))
                .when(artisanProductService).updateProduct(any(String.class), any(Integer.class), any(ArtisanProductFormDTO.class));
    ...
    void addMedia_WhenUploadBatchIsValid_ShouldRedirectWithSuccess() throws Exception {
        when(artisanProductService.addMediaBatch(eq("artisan@test.com"), eq(101), anyList(), anyList(), anyList(), anyList(), eq(0)))
                .thenReturn(2);
    ...
    void addJournalEvent_WhenServiceRejectsNoMedia_ShouldRedirectWithError() throws Exception {
        doThrow(new RuntimeException("Media required"))
                ...
                .addEvent(any(String.class), any(Integer.class), any(LocalDate.class), any(String.class), any(String.class), any(), any(Boolean.class), any());
    ...
    void updateJournalEventText_WhenRequestIsValid_ShouldRedirectWithSuccess() throws Exception {
        ...
        verify(productJournalService).updateEventText("artisan@test.com", 101, 301, "Updated title", "Updated description");
    }
    ...
    private org.springframework.test.web.servlet.request.MockHttpServletRequestBuilder validProductPost(String url) {
        return post(url)
                .param("varietyId", "1")
                .param("segmentId", "2")
