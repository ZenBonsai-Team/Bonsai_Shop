...
/**
 * L3 SYSTEM TEST (HTTP Flow Testing - §3a) cho BF-04: Community Moderation &
 * Auto-Approval.
 * Giả lập chuỗi yêu cầu mạng (multi-step HTTP requests) từ Customer và Content
 * Moderator sử dụng MockMvc.
 */
@SpringBootTest
...
class BF04CommunityModerationSystemTest {
        ...
        void setUp() {
                ...
                Role modRole = roleRepository.findByRoleName("CONTENT_MODERATOR")
                                .orElseGet(() -> roleRepository
                                                .save(Role.builder().roleName("CONTENT_MODERATOR").build()));
        ...
        private RequestPostProcessor customerUser() {
                return user(new CustomUserDetails(customerEntity,
